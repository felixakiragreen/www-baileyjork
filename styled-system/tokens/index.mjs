const tokens = {
  ...
  "colors.felix": {
    "value": "oklch(91.3% 0.2335 130.017)",
    "variable": "var(--colors-felix)"
  },
  "colors.black": {
    "value": "oklch(0% 0 0)",
  ...
  "colors.clear": {
    "value": "oklch(0% 0 0 / 0%)",
    "variable": "var(--colors-clear)"
  },
  "colors.semi": {
    "value": "oklch(0% 0 0 / 50%)",
    "variable": "var(--colors-semi)"
  },
  "colors.grey.50": {
    "value": "#fbfbf7",
  ...
  "shadows.realistic": {
    ...
    "variable": "var(--shadows-realistic)"
  },
  "breakpoints.sm": {
    "value": "640px",
  ...
  "colors.colorPalette.250": {
    "value": "var(--colors-color-palette-250)",
    "variable": "var(--colors-color-palette-250)"
  },
  ...
  "colors.colorPalette.55": {
    "value": "var(--colors-color-palette-55)",
    "variable": "var(--colors-color-palette-55)"
  },
  "colors.colorPalette.60": {
    "value": "var(--colors-color-palette-60)",
    "variable": "var(--colors-color-palette-60)"
  },
  "colors.colorPalette.65": {
    "value": "var(--colors-color-palette-65)",
    "variable": "var(--colors-color-palette-65)"
  },
  ...
  "colors.colorPalette.85": {
    "value": "var(--colors-color-palette-85)",
    "variable": "var(--colors-color-palette-85)"
  },
